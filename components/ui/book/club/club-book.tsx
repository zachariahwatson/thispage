	...
	return (
		<div id={`club-${clubMembershipData.club.id}`} className="max-w-sm md:max-w-4xl w-full space-y-3">
			...
			<Card
				...
				className="h-[calc(100vh-64px)] md:h-[624px] p-4 rounded-3xl relative shadow-shadow shadow-sm bg-card"
			>
...
export function ClubBookSkeleton() {
	return (
		<div className="max-w-sm md:max-w-4xl w-full space-y-3">
			...
			<Skeleton className="h-[calc(100vh-64px)] md:h-[624px] p-4 rounded-3xl" />
		</div>
	)
}
