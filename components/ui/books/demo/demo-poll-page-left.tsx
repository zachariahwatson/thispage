...
import { DemoPollPodium } from "@/components/ui/books/demo"
...
export function DemoPollPageLeft({ userSpreadIndex }: Props) {
	const pollData = {
		id: -1,
	...
	return (
		<PageLeft userSpreadIndex={userSpreadIndex} id={`demo-poll-page-left`}>
			<>
