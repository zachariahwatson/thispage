...
import { CardContent, CardDescription, CardFooter, CardTitle, ToggleGroup } from "@/components/ui"
import { DemoPollItem } from "@/components/ui/books/demo"
...
export function DemoPageRight2({ userSpreadIndex }: Props) {
	...
	return (
		<PageRight userSpreadIndex={userSpreadIndex} id={`demo-page-right-2`}>
