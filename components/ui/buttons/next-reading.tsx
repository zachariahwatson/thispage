...
export function NextReading({ userSpreadIndex, setUserSpreadIndex, len }: Props) {
	...
	return (
		len > 1 && (
			<>
				<motion.div
					className="absolute bottom-4 right-4 border-b-[52px] border-l-[52px] border-b-transparent border-l-page-fold shadow-[-4px_-4px_5px_0_hsl(var(--shadow)/0.66)] rounded-tl-lg rounded-br-lg flex justify-center items-center"
