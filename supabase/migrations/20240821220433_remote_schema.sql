...
create table "_analytics"."log_events_0c7342c2_0f61_4a30_a82b_4ce2baf25e13" (
...
create table "_analytics"."log_events_210fe07f_e6eb_4ec2_bf92_68bc6c427666" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_2534c73a_9d8e_41d1_a772_ccb8ea53f455" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_63a8155e_d7eb_49e0_8ec7_b307b181bda9" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_644fd845_b834_4aff_a768_01d4dcf6af62" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_a78e8cdd_4318_40e2_be55_ba1259e503e6" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_e44e18e1_d74a_442c_b021_616350d2828e" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."schema_migrations_0c7342c2_0f61_4a30_a82b_4ce2baf25e13" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_210fe07f_e6eb_4ec2_bf92_68bc6c427666" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_2534c73a_9d8e_41d1_a772_ccb8ea53f455" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_63a8155e_d7eb_49e0_8ec7_b307b181bda9" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_644fd845_b834_4aff_a768_01d4dcf6af62" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_a78e8cdd_4318_40e2_be55_ba1259e503e6" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_e44e18e1_d74a_442c_b021_616350d2828e" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);
...
CREATE UNIQUE INDEX log_events_0c7342c2_0f61_4a30_a82b_4ce2baf25e13_pkey ON _analytics.log_events_0c7342c2_0f61_4a30_a82b_4ce2baf25e13 USING btree (id);

CREATE UNIQUE INDEX log_events_210fe07f_e6eb_4ec2_bf92_68bc6c427666_pkey ON _analytics.log_events_210fe07f_e6eb_4ec2_bf92_68bc6c427666 USING btree (id);

CREATE UNIQUE INDEX log_events_2534c73a_9d8e_41d1_a772_ccb8ea53f455_pkey ON _analytics.log_events_2534c73a_9d8e_41d1_a772_ccb8ea53f455 USING btree (id);

CREATE UNIQUE INDEX log_events_63a8155e_d7eb_49e0_8ec7_b307b181bda9_pkey ON _analytics.log_events_63a8155e_d7eb_49e0_8ec7_b307b181bda9 USING btree (id);

CREATE UNIQUE INDEX log_events_644fd845_b834_4aff_a768_01d4dcf6af62_pkey ON _analytics.log_events_644fd845_b834_4aff_a768_01d4dcf6af62 USING btree (id);

CREATE UNIQUE INDEX log_events_a78e8cdd_4318_40e2_be55_ba1259e503e6_pkey ON _analytics.log_events_a78e8cdd_4318_40e2_be55_ba1259e503e6 USING btree (id);

CREATE UNIQUE INDEX log_events_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5_pkey ON _analytics.log_events_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5 USING btree (id);

CREATE UNIQUE INDEX log_events_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3_pkey ON _analytics.log_events_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3 USING btree (id);

CREATE UNIQUE INDEX log_events_e44e18e1_d74a_442c_b021_616350d2828e_pkey ON _analytics.log_events_e44e18e1_d74a_442c_b021_616350d2828e USING btree (id);
...
CREATE UNIQUE INDEX schema_migrations_0c7342c2_0f61_4a30_a82b_4ce2baf25e13_pkey ON _analytics.schema_migrations_0c7342c2_0f61_4a30_a82b_4ce2baf25e13 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_210fe07f_e6eb_4ec2_bf92_68bc6c427666_pkey ON _analytics.schema_migrations_210fe07f_e6eb_4ec2_bf92_68bc6c427666 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_2534c73a_9d8e_41d1_a772_ccb8ea53f455_pkey ON _analytics.schema_migrations_2534c73a_9d8e_41d1_a772_ccb8ea53f455 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_63a8155e_d7eb_49e0_8ec7_b307b181bda9_pkey ON _analytics.schema_migrations_63a8155e_d7eb_49e0_8ec7_b307b181bda9 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_644fd845_b834_4aff_a768_01d4dcf6af62_pkey ON _analytics.schema_migrations_644fd845_b834_4aff_a768_01d4dcf6af62 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_a78e8cdd_4318_40e2_be55_ba1259e503e6_pkey ON _analytics.schema_migrations_a78e8cdd_4318_40e2_be55_ba1259e503e6 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5_pkey ON _analytics.schema_migrations_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3_pkey ON _analytics.schema_migrations_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_e44e18e1_d74a_442c_b021_616350d2828e_pkey ON _analytics.schema_migrations_e44e18e1_d74a_442c_b021_616350d2828e USING btree (version);
...
alter table "_analytics"."log_events_0c7342c2_0f61_4a30_a82b_4ce2baf25e13" add constraint "log_events_0c7342c2_0f61_4a30_a82b_4ce2baf25e13_pkey" PRIMARY KEY using index "log_events_0c7342c2_0f61_4a30_a82b_4ce2baf25e13_pkey";

alter table "_analytics"."log_events_210fe07f_e6eb_4ec2_bf92_68bc6c427666" add constraint "log_events_210fe07f_e6eb_4ec2_bf92_68bc6c427666_pkey" PRIMARY KEY using index "log_events_210fe07f_e6eb_4ec2_bf92_68bc6c427666_pkey";

alter table "_analytics"."log_events_2534c73a_9d8e_41d1_a772_ccb8ea53f455" add constraint "log_events_2534c73a_9d8e_41d1_a772_ccb8ea53f455_pkey" PRIMARY KEY using index "log_events_2534c73a_9d8e_41d1_a772_ccb8ea53f455_pkey";

alter table "_analytics"."log_events_63a8155e_d7eb_49e0_8ec7_b307b181bda9" add constraint "log_events_63a8155e_d7eb_49e0_8ec7_b307b181bda9_pkey" PRIMARY KEY using index "log_events_63a8155e_d7eb_49e0_8ec7_b307b181bda9_pkey";

alter table "_analytics"."log_events_644fd845_b834_4aff_a768_01d4dcf6af62" add constraint "log_events_644fd845_b834_4aff_a768_01d4dcf6af62_pkey" PRIMARY KEY using index "log_events_644fd845_b834_4aff_a768_01d4dcf6af62_pkey";

alter table "_analytics"."log_events_a78e8cdd_4318_40e2_be55_ba1259e503e6" add constraint "log_events_a78e8cdd_4318_40e2_be55_ba1259e503e6_pkey" PRIMARY KEY using index "log_events_a78e8cdd_4318_40e2_be55_ba1259e503e6_pkey";

alter table "_analytics"."log_events_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5" add constraint "log_events_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5_pkey" PRIMARY KEY using index "log_events_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5_pkey";

alter table "_analytics"."log_events_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3" add constraint "log_events_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3_pkey" PRIMARY KEY using index "log_events_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3_pkey";

alter table "_analytics"."log_events_e44e18e1_d74a_442c_b021_616350d2828e" add constraint "log_events_e44e18e1_d74a_442c_b021_616350d2828e_pkey" PRIMARY KEY using index "log_events_e44e18e1_d74a_442c_b021_616350d2828e_pkey";
...
alter table "_analytics"."schema_migrations_0c7342c2_0f61_4a30_a82b_4ce2baf25e13" add constraint "schema_migrations_0c7342c2_0f61_4a30_a82b_4ce2baf25e13_pkey" PRIMARY KEY using index "schema_migrations_0c7342c2_0f61_4a30_a82b_4ce2baf25e13_pkey";

alter table "_analytics"."schema_migrations_210fe07f_e6eb_4ec2_bf92_68bc6c427666" add constraint "schema_migrations_210fe07f_e6eb_4ec2_bf92_68bc6c427666_pkey" PRIMARY KEY using index "schema_migrations_210fe07f_e6eb_4ec2_bf92_68bc6c427666_pkey";

alter table "_analytics"."schema_migrations_2534c73a_9d8e_41d1_a772_ccb8ea53f455" add constraint "schema_migrations_2534c73a_9d8e_41d1_a772_ccb8ea53f455_pkey" PRIMARY KEY using index "schema_migrations_2534c73a_9d8e_41d1_a772_ccb8ea53f455_pkey";

alter table "_analytics"."schema_migrations_63a8155e_d7eb_49e0_8ec7_b307b181bda9" add constraint "schema_migrations_63a8155e_d7eb_49e0_8ec7_b307b181bda9_pkey" PRIMARY KEY using index "schema_migrations_63a8155e_d7eb_49e0_8ec7_b307b181bda9_pkey";

alter table "_analytics"."schema_migrations_644fd845_b834_4aff_a768_01d4dcf6af62" add constraint "schema_migrations_644fd845_b834_4aff_a768_01d4dcf6af62_pkey" PRIMARY KEY using index "schema_migrations_644fd845_b834_4aff_a768_01d4dcf6af62_pkey";

alter table "_analytics"."schema_migrations_a78e8cdd_4318_40e2_be55_ba1259e503e6" add constraint "schema_migrations_a78e8cdd_4318_40e2_be55_ba1259e503e6_pkey" PRIMARY KEY using index "schema_migrations_a78e8cdd_4318_40e2_be55_ba1259e503e6_pkey";

alter table "_analytics"."schema_migrations_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5" add constraint "schema_migrations_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5_pkey" PRIMARY KEY using index "schema_migrations_b5dcd05a_15dc_4bf0_88c5_b6ea6f5b25b5_pkey";

alter table "_analytics"."schema_migrations_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3" add constraint "schema_migrations_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3_pkey" PRIMARY KEY using index "schema_migrations_b6cc5c03_0de1_4d75_bbd1_0bbecfef39c3_pkey";

alter table "_analytics"."schema_migrations_e44e18e1_d74a_442c_b021_616350d2828e" add constraint "schema_migrations_e44e18e1_d74a_442c_b021_616350d2828e_pkey" PRIMARY KEY using index "schema_migrations_e44e18e1_d74a_442c_b021_616350d2828e_pkey";
