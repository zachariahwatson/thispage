export default function Page() {
	return (
		<div className="max-w-4xl">
			...
			<br />
			<p>
				These terms and conditions applies to the thispage app (hereby referred to as "Application") for mobile devices
				that was created by Zachariah Watson (hereby referred to as "Service Provider") as a Free service.
			</p>
			<br />
			<p>
