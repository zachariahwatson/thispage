export default function Page() {
	return (
		<div className="max-w-4xl">
			...
			<p>
				This privacy policy applies to the thispage app (hereby referred to as "Application") for mobile devices that
				was created by Zachariah Watson (hereby referred to as "Service Provider") as a Free service. This service is
			...
			<div className="none">
				...
				<ul>
					...
					<li>
						Analytics and Improvements: Aggregated and anonymized location data helps the Service Provider to analyze
			...
			<p>
				...
				certain personally identifiable information, including but not limited to Email, name, phone number, password,
				avatar, username. The information that the Service Provider request will be retained by them and used as
			...
			<ul>
				...
				<li>
					when they believe in good faith that disclosure is necessary to protect their rights, protect your safety or
			...
			<p>
				...
				please contact them at watsonzachariah@gmail.com and they will respond in a reasonable time.
			</p>
			<br />
			...
			<div>
				...
				<p>
					...
					discover that a child under 13 has provided personal information, the Service Provider will immediately delete
					this from their servers. If you are a parent or guardian and you are aware that your child has provided us
					with personal information, please contact the Service Provider (watsonzachariah@gmail.com) so that they will
			...
			<br />
			<p>This privacy policy is effective as of 2024-06-12</p>
			<br />
			...
			<p>
				...
				please contact the Service Provider via email at watsonzachariah@gmail.com.
			</p>
			<hr />
			<p>
