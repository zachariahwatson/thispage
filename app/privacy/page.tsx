...
export default function Page() {
	return (
		<div className={`max-w-4xl ${styles.layout}`}>
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;Our&quot; in this Agreement) refers to thispage.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to thispage, accessible from{" "}
						<a href="https://thispa.ge" rel="external nofollow noopener" target="_blank">
							https://thispa.ge
						</a>
					</p>
				</li>
			...
			<h4>Data Collection from Third-Party Services (Google API)</h4>
			<p>
				We use Google API Services, including Google Sign-In, to enable users to log in using their Google account. When
				you connect your Google account, we may collect the following data from Google:
			</p>
			<ul>
				<li>
			...
			<p>
				We request this data to authenticate your identity and to personalize your experience on our platform. We do not
				request access to any additional data beyond what is necessary for these purposes. If we require further data in
				the future, we will update this Privacy Policy and seek your explicit consent.
			</p>
			<p>
			...
			<p>We use the Google user data collected through Google Sign-In only for the following purposes:</p>
			<ul>
				<li>
					<p>To authenticate your identity and grant access to our services.</p>
				</li>
				<li>
					<p>To provide you with a personalized user experience.</p>
				</li>
			</ul>
			<p>
				We do not use your Google user data for any secondary purposes unless you have explicitly consented to such use.
			</p>
			<p>We will never share your Google user data with third parties except in the following situations:</p>
			<ul>
				<li>
					<p>As required by law</p>
				</li>
				<li>
					<p>To comply with a legal obligation or valid request from law enforcement</p>
				</li>
				<li>
					<p>To prevent fraud or to protect the security of our services</p>
				</li>
			</ul>
			<h4>Sharing Google User Data</h4>
			<p>
				We may share Google user data only with trusted service providers who perform functions on our behalf (e.g.,
				hosting services, data analysis). These parties are contractually obligated to use your data only as necessary
				to provide these services to us.
			</p>
			<p>We do not sell or otherwise share Google user data with third-party advertisers or other external entities.</p>
			...
			<h4>Managing Your Google Data</h4>
			<p>
				You can manage the data we collect from Google by adjusting your Google account settings or by disconnecting
				your Google account from our platform. If you wish to delete any personal data we hold that was collected via
				Google API, you can do so by contacting us at watsonzachariah@gmail.com.
			</p>
			<p>
				We honor requests to delete data promptly, except where retention is required by law or necessary for legitimate
				business purposes (e.g., preventing fraud).
			</p>
			...
			<h2>Compliance with Google API User Data Policy</h2>
			<p>
				We comply with Google's API User Data Policy and Google’s Terms of Service. We ensure that all Google user data
				is handled in accordance with these policies, and we regularly review our privacy practices to ensure continued
				compliance.
			</p>
			...
			<ul>
				<li>By email: watsonzachariah@gmail.com</li>
			</ul>
		</div>
	)
}
